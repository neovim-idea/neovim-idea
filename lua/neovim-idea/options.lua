...
local catppuccin_defaults = {
  ...
  highlight_overrides = {
    ...
    intellijdark = function(colors)
      -- intellij-specific tweaks
      local custom_highlight = "#2e3861"
      return {
        -- [[NeovimIdeaSwitcher]]
        NeovimIdeaSwitcherCursorLine = { bg = custom_highlight, fg = colors.subtext1 },
        NeovimIdeaSwitcherCursorLineNC = { bg = custom_highlight, fg = colors.subtext1 },

        -- [[Neotree]]
        NeoTreeCursorLine = { bg = custom_highlight },

        -- [[Telescope - General]]
        TelescopeSelection = { bg = custom_highlight, fg = colors.subtext1, style = {} },
